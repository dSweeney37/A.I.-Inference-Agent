...
class GreedyBustersAgent(BustersAgent):
	...
	def chooseAction(self, gameState):
		...
		pacmanPosition = gameState.getPacmanPosition()
		successorPositions = [Actions.getSuccessor(pacmanPosition, action) for action in actions]
		#----------------------------------------------------------------------------


		for ghostPositionDistribution in livingGhostPositionDistributions:
			maxProbability = max(ghostPositionDistribution.values())


			for ghostPosition in ghostPositionDistribution:
				if ghostPositionDistribution[ghostPosition] == maxProbability:
		...
		successorDistances = [self.distancer.getDistance(position, closestGhostPosition) for position in successorPositions]

		return actions[successorDistances.index(min(successorDistances))]
